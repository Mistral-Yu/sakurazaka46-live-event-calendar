...
- 生成補助: `scripts/calendar_rules.json`、`scripts/holidays_template.json`、`scripts/sakurazaka46_members_template.json`、`scripts/fortune_meet_html_to_plan_json.py`
